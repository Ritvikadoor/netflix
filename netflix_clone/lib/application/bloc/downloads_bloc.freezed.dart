...
mixin _$DownloadsState {
  ...
  List<DataClass>? get downloads => throw _privateConstructorUsedError;
  Option<Either<MainFailures, List<DataClass>>>
...
class _$DownloadsStateCopyWithImpl<$Res>
  ...
  $Res call({
    ...
    Object? downloadsFailureSuccessOption = freezed,
  }) {
    return _then(_value.copyWith(
      ...
      downloads: downloads == freezed
          ...
          : downloads // ignore: cast_nullable_to_non_nullable
              as List<DataClass>?,
      downloadsFailureSuccessOption: downloadsFailureSuccessOption == freezed
          ? _value.downloadsFailureSuccessOption
          : downloadsFailureSuccessOption // ignore: cast_nullable_to_non_nullable
              as Option<Either<MainFailures, List<DataClass>>>,
    ));
  }
}
...
class _$_DownloadsState implements _DownloadsState {
  const _$_DownloadsState(
      ...
      final List<DataClass>? downloads,
      required this.downloadsFailureSuccessOption})
      : _downloads = downloads;

  @override
  final bool isLoading;
  final List<DataClass>? _downloads;
  @override
  List<DataClass>? get downloads {
  ...
  @override
  final Option<Either<MainFailures, List<DataClass>>>
      downloadsFailureSuccessOption;
  ...
  int get hashCode => Object.hash(
      ...
      const DeepCollectionEquality().hash(downloadsFailureSuccessOption));
...
abstract class _DownloadsState implements DownloadsState {
  const factory _DownloadsState(
      ...
      final List<DataClass>? downloads,
      required final Option<Either<MainFailures, List<DataClass>>>
